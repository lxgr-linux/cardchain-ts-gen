...
export const Council: MessageFns<Council> = {
  encode(message: Council, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.cardId !== 0) {
    ...
    for (const v of message.hashResponses) {
      WrapHashResponse.encode(v!, writer.uint32(26).fork()).join();
    }
    for (const v of message.clearResponses) {
      WrapClearResponse.encode(v!, writer.uint32(34).fork()).join();
    }
    if (message.treasury !== undefined) {
      Coin.encode(message.treasury, writer.uint32(66).fork()).join();
    }
    if (message.status !== 0) {
  ...
  fromJSON(object: any): Council {
    return {
      ...
      hashResponses: globalThis.Array.isArray(object?.hashResponses)
        ? object.hashResponses.map((e: any) => WrapHashResponse.fromJSON(e))
        : [],
      clearResponses: globalThis.Array.isArray(object?.clearResponses)
        ? object.clearResponses.map((e: any) => WrapClearResponse.fromJSON(e))
        : [],
      treasury: isSet(object.treasury) ? Coin.fromJSON(object.treasury) : undefined,
      status: isSet(object.status) ? councelingStatusFromJSON(object.status) : 0,
      trialStart: isSet(object.trialStart) ? globalThis.Number(object.trialStart) : 0,
    };
  },
  ...
  toJSON(message: Council): unknown {
    ...
    if (message.treasury !== undefined) {
      obj.treasury = Coin.toJSON(message.treasury);
    }
    if (message.status !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<Council>, I>>(object: I): Council {
    ...
    message.treasury = (object.treasury !== undefined && object.treasury !== null)
      ? Coin.fromPartial(object.treasury)
      : undefined;
...
export const WrapClearResponse: MessageFns<WrapClearResponse> = {
  encode(message: WrapClearResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.user !== "") {
...
export const WrapHashResponse: MessageFns<WrapHashResponse> = {
  encode(message: WrapHashResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.user !== "") {
      writer.uint32(10).string(message.user);
    }
    if (message.hash !== "") {
