...
export const Zealy: MessageFns<Zealy> = {
  encode(message: Zealy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  create<I extends Exact<DeepPartial<Zealy>, I>>(base?: I): Zealy {
    return Zealy.fromPartial(base ?? ({} as any));
  },
