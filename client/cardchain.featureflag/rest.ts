...
import { QueryParamsResponse } from "../types/cardchain/featureflag/query";
import { QueryFlagResponse } from "../types/cardchain/featureflag/query";
import { QueryFlagsResponse } from "../types/cardchain/featureflag/query";

import { QueryParamsRequest } from "../types/cardchain/featureflag/query";
import { QueryFlagRequest } from "../types/cardchain/featureflag/query";
import { QueryFlagsRequest } from "../types/cardchain/featureflag/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name queryFlag
   * @request GET:/DecentralCardGame/cardchain/featureflag/flag/{module}/{name}
   */
  queryFlag = (module: string, name: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryFlagResponse>>>({
      path: `/DecentralCardGame/cardchain/featureflag/flag/${module}/${name}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name queryFlags
   * @request GET:/DecentralCardGame/cardchain/featureflag/flags
   */
  queryFlags = (
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryFlagsResponse>>>({
      path: `/DecentralCardGame/cardchain/featureflag/flags`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
